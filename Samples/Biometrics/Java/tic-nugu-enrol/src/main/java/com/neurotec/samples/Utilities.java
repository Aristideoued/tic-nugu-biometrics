...
public final class Utilities {
	...
	public static void showError(Container owner, String message) {
		SwingUtilities.invokeLater(() -> { JOptionPane.showMessageDialog(owner, message, String.format("%s: %s", getCurrentApplicationName(), ERROR_TITLE), JOptionPane.ERROR_MESSAGE); });
	}
	...
	public static void showInformation(Container owner, String message) {
		SwingUtilities.invokeLater(() -> { JOptionPane.showMessageDialog(owner, message, String.format("%s: %s", getCurrentApplicationName(), INFORMATION_TITLE), JOptionPane.INFORMATION_MESSAGE); });
	}
	...
	public static void showWarning(Container owner, String message) {
		SwingUtilities.invokeLater(() -> { JOptionPane.showMessageDialog(owner, message, getCurrentApplicationName() + ": " + WARNING_TITLE, JOptionPane.WARNING_MESSAGE); });
	}
