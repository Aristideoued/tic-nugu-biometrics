...
public class PrincipalUIZZZ  extends JFrame{
  ...
  /*  private JButton bouton = new JButton("bouton1");
    ...
    private JMenuItem creer = new JMenuItem("nouvel utilisateur");
    private JMenuItem listeUtilisateur = new JMenuItem("Liste");

    private CreerUserUI creerUserUI;
    public PrincipalUIZZZ(){}
...
//this.menuBar.add(utilisateur);
        ...
        /*creer.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                CreerUserUI creerUserUI = new CreerUserUI();
