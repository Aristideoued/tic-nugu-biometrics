...
public final class FingersPanel extends JPanel implements ActionListener {
	...
	private final String[] fingerNames = new String[] {"Pouce", "Index", "Majeur", "Annulaire", "Auriculaire"};
	private final String[] fingerPosition = new String[] {"Gauche", "Droite"};
	...
	private void initializeComponents() {
		...
		chkShowOriginal = new JCheckBox("Afficher les images originales");
		...
		for (int i = 0; i < 5; i++) {
			gridBagUtis.addToGridBagLayout(i, 1, 1, 1, 0.2, 0, this, new JLabel( fingerNames[i].toString()+" "+fingerPosition[0].toString()));
		}
		...
		for (int i = 0; i < 5; i++) {
			gridBagUtis.addToGridBagLayout(i, 3, 1, 1, 0.2, 0, this, new JLabel( fingerNames[i].toString()+" "+fingerPosition[1].toString()));
		}
