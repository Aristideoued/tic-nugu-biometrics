...
public final class DeviceSelectDialog extends JDialog implements ActionListener {
	...
	public DeviceSelectDialog(Frame owner) {
		super(owner, "Selectionner le scanner", true);
	...
	private void initializeComponents() {
		...
		gridBagUtils.addToGridBagLayout(0, 0, 4, 1, mainPanel, new JLabel("Selectionner le scanner"));
	...
	private void btnOkClick() {
		if (selectedDevice != null) {
			...
			Utilities.showWarning(this, "Scanner non selectionné");
		}
	}
