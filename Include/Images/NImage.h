...
#define NI_READ_ONLY               0x00000002
#define NI_UNINITIALIZED_PIXELS    0x00000004
#define NI_USE_CONVERSION_CACHE    0x00000008
...
NResult N_API NImageGetPlaneConstPtr(HNImage hImage, NInt index, const void * * pValue);
...
NResult N_API NImageGetPlaneConstPtrs(HNImage hImage, const void * * arValues, NInt valuesLength);
...
NResult N_API NImageGetPaletteConstPtr(HNImage hImage, const void * * pValue);
...
NResult N_API NImageGetPixelsConstPtr(HNImage hImage, const void * * pValue);
NResult N_API NImageGetPixelsConstBytePtr(HNImage hImage, const NByte * * pValue);
