...
NResult N_API NImageInfoGetHorzResolution(HNImageInfo hImage, NFloat * pValue);
NResult N_API NImageInfoGetVertResolution(HNImageInfo hImage, NFloat * pValue);
NResult N_API NImageInfoGetResolutionIsAspectRatio(HNImageInfo hImage, NBool * pValue);
