...
NResult N_API NrgbipRotatedCopy(HNImage hImage, NInt centerX, NInt centerY, NDouble angle, NInt radiusX, NInt radiusY, NBool interpolateBackground, NRgb backgroundColor,
	NUInt resultWidth, NUInt resultHeight, NSizeType resultStride, HNImage * phResultImage);
