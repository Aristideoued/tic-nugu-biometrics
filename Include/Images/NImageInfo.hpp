...
public:
	...
	{
		NFloat value;
		NCheck(NImageInfoGetHorzResolution(GetHandle(), &value));
		return value;
	}
	...
	{
		NFloat value;
		NCheck(NImageInfoGetVertResolution(GetHandle(), &value));
		return value;
	}
	...
	{
		NBool value;
		NCheck(NImageInfoGetResolutionIsAspectRatio(GetHandle(), &value));
		return value != 0;
	}
