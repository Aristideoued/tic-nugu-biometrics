...
NResult N_API NLicManGenerateSerialExN(HNLicManDongle hDongle, NUInt productId, NInt sequenceNumber, NInt * pDistributorId, HNString * phValue);

NResult N_API NLicManGenerateLicenseN(HNString hId, NInt * pSequenceNumber, NUInt * pProductId, HNString * phValue);
NResult N_API NLicManGenerateLicenseExN(HNLicManDongle hDongle, HNString hId, NInt * pSequenceNumber, NUInt * pProductId, HNString * phValue);

NResult N_API NLicManGetLicenseDataN(HNString hId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
NResult N_API NLicManGetLicenseDataExN(HNLicManDongle hDongle, HNString hId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
#ifndef N_NO_ANSI_FUNC
NResult N_API NLicManGetLicenseDataA(const NAChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
NResult N_API NLicManGetLicenseDataExA(HNLicManDongle hDongle, const NAChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
#endif
#ifndef N_NO_UNICODE
NResult N_API NLicManGetLicenseDataW(const NWChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
NResult N_API NLicManGetLicenseDataExW(HNLicManDongle hDongle, const NWChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NLicManGetLicenseData(const NChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
NResult N_API NLicManGetLicenseDataEx(HNLicManDongle hDongle, const NChar * szId, NInt * pSequenceNumber, NUInt * pProductId, NInt * pDistributorId);
#endif
#define NLicManGetLicenseData N_FUNC_AW(NLicManGetLicenseData)
#define NLicManGetLicenseDataEx N_FUNC_AW(NLicManGetLicenseDataEx)
...
NResult N_API NLicManGetClientId(HNString * phValue);
NResult N_API NLicManSetClientIdN(HNString hValue);
