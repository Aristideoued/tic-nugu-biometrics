...
typedef enum NLicenseObtainedStatus_
{
	nlosUnknown = 0,
	nlosLicenseObtained = 1,
	nlosLicenseNotObtained = 2,
	nlosServerOffline = 3,
} NLicenseObtainedStatus;

N_DECLARE_TYPE(NLicenseObtainedStatus)
...
NResult N_API NLicenseAddFromBuffer(HNBuffer hBuffer);
...
NResult N_API NLicenseGetObtainedStatusN(HNString hAddress, HNString hPort, HNString hProduct, NLicenseObtainedStatus * pStatus);
#ifndef N_NO_ANSI_FUNC
NResult N_API NLicenseGetObtainedStatusA(const NAChar * szAddress, const NAChar * szPort, const NAChar * szProduct, NLicenseObtainedStatus * pStatus);
#endif
#ifndef N_NO_UNICODE
NResult N_API NLicenseGetObtainedStatusW(const NWChar * szAddress, const NWChar * szPort, const NWChar * szProduct, NLicenseObtainedStatus * pStatus);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NLicenseGetObtainedStatus(const NChar * szAddress, const NChar * szPort, const NChar * szProduct, NLicenseObtainedStatus * pStatus);
#endif
#define NLicenseGetObtainedStatus N_FUNC_AW(NLicenseGetObtainedStatus)

NResult N_API NLicenseGetObtainedComponentStatusN(HNString hAddress, HNString hPort, HNString hComponent, NLicenseObtainedStatus * pStatus);
#ifndef N_NO_ANSI_FUNC
NResult N_API NLicenseGetObtainedComponentStatusA(const NAChar * szAddress, const NAChar * szPort, const NAChar * szComponent, NLicenseObtainedStatus * pStatus);
#endif
#ifndef N_NO_UNICODE
NResult N_API NLicenseGetObtainedComponentStatusW(const NWChar * szAddress, const NWChar * szPort, const NWChar * szComponent, NLicenseObtainedStatus * pStatus);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NLicenseGetObtainedComponentStatus(const NChar * szAddress, const NChar * szPort, const NChar * szComponent, NLicenseObtainedStatus * pStatus);
#endif
#define NLicenseGetObtainedComponentStatus N_FUNC_AW(NLicenseGetObtainedComponentStatus)
