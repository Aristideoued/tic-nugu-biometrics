...
typedef NResult (N_CALLBACK NdmPreviewSignatureScannerProc)(NHandle hDevice, HNObject hCaptureInfo, HNSignature hSignature, NBiometricStatus * pStatus, void * pParam);
...
typedef struct NdmInterfaceV1_
{
	...
	// V1.8
	//--------
	// Mandatory for ndtSignatureScanner.
	NResult(N_CALLBACK CaptureSignatureScanner)(NHandle hDevice, HNObject hCaptureInfo, NInt timeoutMilliseconds, const HNAAttributes * arhObjects, NInt objectCount,
		HNSignature * phSignature, NBiometricStatus * pStatus, NdmPreviewSignatureScannerProc pPreview, void * pParam);
	// Mandatory for ndtSignatureScanner.
	NResult(N_CALLBACK ClearSignatureScanner)(NHandle hDevice, void * pParam);
	//--------
	// V1.9
	//--------
	// Optional
	NResult(N_CALLBACK GetCameraVideoSample)(NHandle hDevice, HNVideoSample * phSample, void * pParam);
} NdmInterfaceV1;
