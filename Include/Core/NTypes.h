...
#define N_FOREACH_LP_(type, name, pList) \
	{\
		type * name;\
		type * N_FOREACH_LP_##name##sStart;\
		type * N_FOREACH_LP_##name##sEnd;\
		N_CHECK(NListGetStart(pList, sizeof(*N_FOREACH_LP_##name##sStart), NULL, (void * *)&N_FOREACH_LP_##name##sStart));\
		N_CHECK(NListGetEnd(pList, sizeof(*N_FOREACH_LP_##name##sEnd), NULL, (void * *)&N_FOREACH_LP_##name##sEnd));\
		for (name = N_FOREACH_LP_##name##sStart; name < N_FOREACH_LP_##name##sEnd; name++)\
		{
...
#define N_FOREACH_LRP_(type, name, pList) \
	{\
		...
		type * N_FOREACH_LRP_##name##sEnd;\
		N_CHECK(NListGetStart(pList, sizeof(*N_FOREACH_LRP_##name##sStart), NULL, (void * *)&N_FOREACH_LRP_##name##sStart));\
		N_CHECK(NListGetEnd(pList, sizeof(*N_FOREACH_LRP_##name##sEnd), NULL, (void * *)&N_FOREACH_LRP_##name##sEnd));\
		for (name = N_FOREACH_LRP_##name##sEnd - 1; N_FOREACH_LRP_##name##sStart != NULL && name >= N_FOREACH_LRP_##name##sStart; name--)\
		{
...
#define N_FOREACH_LLP_(type, name, pList, listIndex) \
	{\
		type * name;\
		type * N_FOREACH_LLP_##name##sStart;\
		type * N_FOREACH_LLP_##name##sEnd;\
		N_CHECK(NListListGetItemsStart(pList, listIndex, sizeof(*N_FOREACH_LLP_##name##sStart), NULL, (void * *)&N_FOREACH_LLP_##name##sStart));\
		N_CHECK(NListListGetItemsEnd(pList, listIndex, sizeof(*N_FOREACH_LLP_##name##sEnd), NULL, (void * *)&N_FOREACH_LLP_##name##sEnd));\
		for (name = N_FOREACH_LLP_##name##sStart; name < N_FOREACH_LLP_##name##sEnd; name++)\
		{
...
#define N_FOREACH_LLRP_(type, name, pList, listIndex) \
	{\
		...
		type * N_FOREACH_LLRP_##name##sEnd;\
		N_CHECK(NListListGetItemsStart(pList, listIndex, sizeof(*N_FOREACH_LLRP_##name##sStart), NULL, (void * *)&N_FOREACH_LLRP_##name##sStart));\
		N_CHECK(NListListGetItemsEnd(pList, listIndex, sizeof(*N_FOREACH_LLRP_##name##sEnd), NULL, (void * *)&N_FOREACH_LLRP_##name##sEnd));\
		for (name = N_FOREACH_LLRP_##name##sEnd - 1; name >= N_FOREACH_LLRP_##name##sStart; name--)\
		{
...
#ifndef N_CPP_API_HEADER_INCLUDED
