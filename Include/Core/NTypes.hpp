...
public:
	...
	NCollectionIterator(const NCollectionIterator & other)
		: collection(other.collection), reverse(other.reverse), index(other.index), count(other.count)
	{
	}
...
#ifdef N_CPP11
	NArrayWrapper(NArrayWrapper<T> && other) noexcept
