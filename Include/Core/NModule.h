...
NResult N_API NModuleGetSrcRevision(HNModule hModule, HNString * phValue);
NResult N_API NModuleSetSrcRevisionN(HNModule hModule, HNString hValue);
#ifndef N_NO_ANSI_FUNC
NResult N_API NModuleSetSrcRevisionA(HNModule hModule, const NAChar * szValue);
#endif
#ifndef N_NO_UNICODE
NResult N_API NModuleSetSrcRevisionW(HNModule hModule, const NWChar * szValue);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NModuleSetSrcRevision(HNModule hModule, const NChar * szValue);
#endif
#define NModuleSetSrcRevision N_FUNC_AW(NModuleSetSrcRevision)
