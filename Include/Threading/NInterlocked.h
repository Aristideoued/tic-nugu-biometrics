...
#if defined(N_ARM_FAMILY)
# if defined(N_MSVC)
#  define NYieldProcessor() YieldProcessor()
# elif (defined(__ARM_ARCH) && (__ARM_ARCH >= 6)) || defined(N_ARM64)
#  define NYieldProcessor() asm volatile ("yield" ::: "memory")
# else
#  define NYieldProcessor() asm volatile ("nop" ::: "memory")
# endif
#elif defined(N_POWER_PC)
# define NYieldProcessor() asm volatile ("or 27,27,27" ::: "memory")
#elif defined(N_X86_FAMILY)
# if defined(N_MSVC)
#  define NYieldProcessor() YieldProcessor()
# else
#  define NYieldProcessor() asm volatile ("pause" ::: "memory")
# endif
#else
# define NYieldProcessor()
#endif
