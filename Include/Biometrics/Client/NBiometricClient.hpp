...
#include <Biometrics/Client/NMMAbisConnection.hpp>
...
#include <Devices/NSignatureScanner.hpp>
...
using ::Neurotec::Devices::HNSignatureScanner;
...
public:
	...
	::Neurotec::Devices::NSignatureScanner GetSignatureScanner() const
	{
		return GetObject<HandleType, ::Neurotec::Devices::NSignatureScanner>(NBiometricClientGetSignatureScanner, true);
	}

	void SetSignatureScanner(const ::Neurotec::Devices::NSignatureScanner & value)
	{
		return SetObject(NBiometricClientSetSignatureScanner, value);
	}
