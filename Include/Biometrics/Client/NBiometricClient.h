...
NResult N_API NBiometricClientGetSignatureScanner(HNBiometricClient hBiometricClient, HNSignatureScanner * phValue);
NResult N_API NBiometricClientSetSignatureScanner(HNBiometricClient hBiometricClient, HNSignatureScanner hValue);
