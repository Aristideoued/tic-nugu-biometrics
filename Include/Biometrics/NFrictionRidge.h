...
NResult N_API NFrictionRidgeGetRidgeAreaImage(HNFrictionRidge hFrictionRidge, HNImage * phValue);
NResult N_API NFrictionRidgeSetRidgeAreaImage(HNFrictionRidge hFrictionRidge, HNImage hValue);
