...
NResult N_API NFAttributesGetNfiq(HNFAttributes hAttributes, NVersion_ version, NByte * pValue);
NResult N_API NFAttributesSetNfiq(HNFAttributes hAttributes, NVersion_ version, NByte value);
