...
NResult N_API NFRecordGetNfiq(HNFRecord hRecord, NVersion_ version, NByte * pValue);
NResult N_API NFRecordSetNfiq(HNFRecord hRecord, NVersion_ version, NByte value);
