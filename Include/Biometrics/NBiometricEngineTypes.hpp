...
N_DEFINE_ENUM_TYPE_TRAITS(Neurotec::Biometrics, NExtractionScenario)
N_DEFINE_ENUM_TYPE_TRAITS(Neurotec::Biometrics, NMatchingScenario)
...
public:
	...
	static NType NExtractionScenarioNativeTypeOf()
	{
		return NObject::GetObject<NType>(N_TYPE_OF(NExtractionScenario), true);
	}
	static NType NMatchingScenarioNativeTypeOf()
	{
		return NObject::GetObject<NType>(N_TYPE_OF(NMatchingScenario), true);
	}
};
