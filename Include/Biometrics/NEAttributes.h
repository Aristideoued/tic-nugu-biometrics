...
NResult N_API NEAttributesGetDetectedPosition(HNEAttributes hAttributes, NEPosition * pValue);
NResult N_API NEAttributesSetDetectedPosition(HNEAttributes hAttributes, NEPosition value);
...
NResult N_API NEAttributesGetRotationAngle(HNEAttributes hAttributes, NFloat * pValue);
NResult N_API NEAttributesSetRotationAngle(HNEAttributes hAttributes, NFloat value);
