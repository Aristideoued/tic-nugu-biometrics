...
NResult N_API FIRecordSaveToMemoryN(HNObject hObject, BdifEncodingType encodingType, NUInt flags, HNBuffer * phBuffer);
NResult N_API FIRecordSaveToStream(HNObject hObject, HNStream hStream, BdifEncodingType encodingType, NUInt flags);
