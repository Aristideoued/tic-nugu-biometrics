...
NResult N_API NSubjectGetSignatureCount(HNSubject hSubject, NInt * pValue);
NResult N_API NSubjectGetSignature(HNSubject hSubject, NInt index, HNSignature * phValue);
NResult N_API NSubjectGetSignatures(HNSubject hSubject, HNSignature * * parhValues, NInt * pValueCount);
NResult N_API NSubjectGetSignatureCapacity(HNSubject hSubject, NInt * pValue);
NResult N_API NSubjectSetSignatureCapacity(HNSubject hSubject, NInt value);
NResult N_API NSubjectSetSignature(HNSubject hSubject, NInt index, HNSignature hValue);
NResult N_API NSubjectAddSignature(HNSubject hSubject, HNSignature hValue, NInt * pIndex);
NResult N_API NSubjectInsertSignature(HNSubject hSubject, NInt index, HNSignature hValue);
NResult N_API NSubjectRemoveSignatureAt(HNSubject hSubject, NInt index);
NResult N_API NSubjectClearSignatures(HNSubject hSubject);

NResult N_API NSubjectAddSignaturesCollectionChanged(HNSubject hSubject, HNCallback hCallback);
NResult N_API NSubjectAddSignaturesCollectionChangedCallback(HNSubject hSubject, N_COLLECTION_CHANGED_CALLBACK_ARG(HNSignature, pCallback), void * pParam);
NResult N_API NSubjectRemoveSignaturesCollectionChanged(HNSubject hSubject, HNCallback hCallback);
NResult N_API NSubjectRemoveSignaturesCollectionChangedCallback(HNSubject hSubject, N_COLLECTION_CHANGED_CALLBACK_ARG(HNSignature, pCallback), void * pParam);
