...
public:
	...
	static bool IsNfiqValid(NVersion version, NByte value)
	{
		NBool result;
		NCheck(NfiqIsValid(version.GetValue(), value, &result));
		return result != 0;
	}

	static NByte NfiqQualityToNfiq1(NfiqQuality nfiqQuality)
	{
		NByte nfiq1;
		NCheck(NBiometricNfiqQualityToNfiq1(nfiqQuality, &nfiq1));
		return nfiq1;
	}

	static NfiqQuality Nfiq1ToNfiqQuality(NByte nfiq1)
	{
		NfiqQuality nfiqQuality;
		NCheck(NBiometricNfiq1ToNfiqQuality(nfiq1, &nfiqQuality));
		return nfiqQuality;
	}
	...
	static NInt AngleFromDegrees(NFloat value)
	{
