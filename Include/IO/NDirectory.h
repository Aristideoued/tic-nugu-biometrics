...
NResult N_API NDirectoryCreateN(HNString hPath);
#ifndef N_NO_ANSI_FUNC
NResult N_API NDirectoryCreateA(const NAChar * szPath);
#endif
#ifndef N_NO_UNICODE
NResult N_API NDirectoryCreateW(const NWChar * szPath);
#endif
#ifdef N_DOCUMENTATION
NResult N_API NDirectoryCreate(const NChar * szPath);
#endif
#define NDirectoryCreate N_FUNC_AW(NDirectoryCreate)
