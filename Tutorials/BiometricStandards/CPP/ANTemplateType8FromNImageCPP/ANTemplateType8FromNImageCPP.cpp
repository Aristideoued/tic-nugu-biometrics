...
{
	cout << "usage:" << endl;
	cout << "\t" << title << " [NImage] [ANTemplate] [Tot] [Dai] [Ori] [Tcn] [Encoding]" << endl << endl;
...
int main(int argc, NChar ** argv)
{
	...
	//static const NChar * licenses[MAX_LICENSES] = { N_T("FingerFastExtrctor"),N_T("FaceFastExtractor"),N_T("IrisFastExtractor") };
	...
	try
	{
		...
		ANType8Record record = antemplate.GetRecords().AddType8(anstOfficial, ansrtScannedUncompressed, true, image);
