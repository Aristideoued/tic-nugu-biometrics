...
const NChar description[] = N_T("Demonstrates creation of ANTemplate with current version and type 15 record in it");
...
int main(int argc, NChar ** argv)
{
	...
	const NString license = N_T("PalmClient");
	...
	try
	{
		...
		*/
		...
		ANType15Record record = antemplate.GetRecords().AddType15(src, imageData);
