...
public final class ANTemplateType6FromNImage {
	...
	public static void main(String[] args) {
		...
		try {
			 ...
			 * Finger image must be compressed using valid compression algorithm for Type-6 record.
			...
			*/
			...
			record = template.getRecords().addType6(true, ANBinaryImageCompressionAlgorithm.NONE, image);
