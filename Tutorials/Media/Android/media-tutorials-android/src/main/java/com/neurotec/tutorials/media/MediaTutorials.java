...
public final class MediaTutorials extends ListActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
	...
	private static String TAG = MediaTutorials.class.getSimpleName();
