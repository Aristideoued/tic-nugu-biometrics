...
public final class IdentifyFinger {
	...
	public static void main(String[] args) {
		...
		final String licenses = "FingerMatcher,FingerExtractor";
		//final String licenses = "FingerMatcher,FingerClient";
		//final String licenses = "FingerFastMatcher,FingerFastExtractor";
